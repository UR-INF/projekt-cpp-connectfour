...
int PlayerDrop( char board[][10], playerInfo activePlayer )
{
	...
	do
	{
		cout <<"Tura gracza " << activePlayer.playerName;
		cout << " Gdzie chcesz umiescic swoj znak? (1-7)";
		cin  >> dropChoice;

		while ( board[1][dropChoice] == 'X' || board[1][dropChoice] == 'O' )
		{
			cout << "Ta kolumna jest juz pelna!";
			cin  >> dropChoice;
		}
...
void PlayerWin ( playerInfo activePlayer )
{
	cout << endl << activePlayer.playerName << " zwycieza!" << endl;
}
